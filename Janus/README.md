...
Ветка `claude/metajanus`, **12 коммитов над origin/main** (Phase 0.5→2a + 3 F-фикса + стадия A аудита
Fable A-1…A-6), дерево чистое, **build 0 ворнингов, 26/26 тестов зелёные**. Слой ИЗМЕРИТЕЛЬНЫЙ и ИНЕРТНЫЙ
